...
exports.create = async (req, res, next) => {
    const { title, description, support, cover, href, price, status, discount, categoryID } =
        req.body;
...
exports.register = async (req, res, next) => {
    ...
    const { price: coursePrice } = await courseModel.findById({ _id: id }).select('price');
    const register = await courseUserModel.create({ user: userId, course: id, price: coursePrice });
